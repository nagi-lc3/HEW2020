                ...
                <div class="col-lg-6 col-md-12 mb-4">
                  ...
                  <div class="single-news">
                    ...
                    <div class="view overlay rounded z-depth-1-half mb-4">
                      <img class="img-fluid" src="images/update.jpg" alt="Sample image">
                      <a href="index.php">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-3">
                        ...
                        <div class="view overlay rounded z-depth-1 mb-4">
                          <img class="img-fluid" src="images/fish1.jpg" alt="Sample image">
                  ...
                  <div class="single-news mb-4">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-3">
                        <!--Image-->
                        <div class="view overlay rounded z-depth-1 mb-4">
                          <img class="img-fluid" src="images/fish2.jpg" alt="Sample image">
                          <a href="#">
                            <div class="mask rgba-white-slight"></div>
                          </a>
                        </div>
                  ...
                  <div class="single-news mb-4">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-3">
                        <!--Image-->
                        <div class="view overlay rounded z-depth-1 mb-4">
                          <img class="img-fluid" src="images/fish3.jpg" alt="Sample image">
                          <a href="#">
                            <div class="mask rgba-white-slight"></div>
                          </a>
                        </div>
