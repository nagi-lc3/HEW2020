              ...
              <div class="row d-flex justify-content-center">
                ...
                <div class="">
                  ...
                  <form action="./sign_up_confirm.php" method="POST">
                    ...
                    <!-- パスワード -->
                    <small id="defaultRegisterFormPasswordHelpBlock" class="form-text text-muted pl-1 sign_up_label">パスワード（半角整数8文字以上？？）</small>
                    ...
                    <!-- 郵便番号 -->
                    <small id="defaultRegisterFormPasswordHelpBlock" class="form-text text-muted pl-1 sign_up_label">郵便番号</small>
                    ...
                    <!-- 生年月日 -->
                    <small id="defaultRegisterFormPasswordHelpBlock" class="form-text text-muted pl-1 sign_up_label">生年月日</small>
                    <input type="text" name="birthday" id="defaultRegisterBirthday" class="form-control mb-3" placeholder="2020-01-11">

                    <div class="form-row mb-3">
                      <div class="col">
                        <!-- 第3者質問 -->
                        <small id="defaultRegisterFormPasswordHelpBlock" class="form-text text-muted pl-1 sign_up_label">第3者質問</small>
                      ...
                      <div class="col">
                        <!-- 答え -->
                        <small id="defaultRegisterFormPasswordHelpBlock" class="form-text text-muted pl-1 sign_up_label">答え</small>
